...
public class RequestParams {
     ...
     * @param keysAndValues a sequence of keys and values. Objects are automatically converted to Strings (including the value
     *        {@code null}).
    ...
    /**
     * 可以通过传递progressHandler来进行文件下载进度的控制，目前没有实现
     * @param progressHandler
     * @return
     * @throws IOException
     */
    public HttpEntity getEntity(AsyncSimpleHttpResponseHandler progressHandler) throws IOException {
